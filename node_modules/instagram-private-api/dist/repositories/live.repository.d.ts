...
export declare class LiveRepository extends Repository {
    ...
    getPostLiveThumbnails(broadcastId: string): Promise<LivePostLiveThumbnailsResponseRootObject>;
    ...
    addPostLiveToIgtv({ broadcastId, title, description, coverUploadId, igtvSharePreviewToFeed, }: {
        broadcastId: string;
        title: string;
        description: string;
    ...
    addToPostLive(broadcastId: string): Promise<LiveAddToPostResponse>;

...
import { AccountRepositoryCurrentUserResponseRootObject, AccountRepositoryLoginResponseLogged_in_user, StatusResponse } from 'instagram-private-api/dist/responses';
import { AccountEditProfileOptions, AccountTwoFactorLoginOptions } from 'instagram-private-api/dist/types';
export declare class AccountRepository extends Repository {
    ...
    currentUser(): Promise<import("instagram-private-api/dist/responses").AccountRepositoryCurrentUserResponseUser>;
    setBiography(text: string): Promise<import("instagram-private-api/dist/responses").AccountRepositoryCurrentUserResponseUser>;
    changeProfilePicture(picture: Buffer): Promise<AccountRepositoryCurrentUserResponseRootObject>;
    editProfile(options: AccountEditProfileOptions): Promise<import("instagram-private-api/dist/responses").AccountRepositoryCurrentUserResponseUser>;

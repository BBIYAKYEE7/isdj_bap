...
import { MediaEditResponseRootObject, MediaInfoResponseRootObject, MediaRepositoryLikersResponseRootObject, MediaUpdatedMediaResponseRootObject, StatusResponse } from 'instagram-private-api/dist/responses';
import { IgAppModule, LikeRequestOptions, UnlikeRequestOptions, MediaConfigureStoryPhotoOptions, MediaConfigureStoryVideoOptions, MediaConfigureTimelineOptions, MediaConfigureSidecarOptions, MediaConfigureTimelineVideoOptions, MediaConfigureToIgtvOptions } from 'instagram-private-api/dist/types';
import { MediaRepositoryConfigureResponseRootObject } from 'instagram-private-api/dist/responses';
import { MediaRepositoryCheckOffensiveCommentResponseRootObject } from 'instagram-private-api/dist/responses';
import { StoryMusicQuestionResponse, StoryTextQuestionResponse } from 'instagram-private-api/dist/types/story-response.options';
export declare class MediaRepository extends Repository {
    ...
    comment({ mediaId, text, replyToCommentId, module, }: {
        ...
        module?: string;
    }): Promise<import("instagram-private-api/dist/responses").MediaRepositoryCommentResponseComment>;
    ...
    private storyCountdownAction;
    storyCountdownFollow(countdownId: string | number): Promise<StatusResponse>;
    storyCountdownUnfollow(countdownId: string | number): Promise<StatusResponse>;
}

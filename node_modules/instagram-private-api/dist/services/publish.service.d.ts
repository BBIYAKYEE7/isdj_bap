...
import { PostingAlbumOptions, PostingPhotoOptions, PostingStoryPhotoOptions, PostingStoryVideoOptions, PostingVideoOptions } from 'instagram-private-api/dist/types';
...
export declare class PublishService extends Repository {
    ...
    photo(options: PostingPhotoOptions): Promise<import("instagram-private-api/dist/responses").MediaRepositoryConfigureResponseRootObject>;
    video(options: PostingVideoOptions): Promise<import("instagram-private-api/dist/responses").MediaRepositoryConfigureResponseRootObject>;

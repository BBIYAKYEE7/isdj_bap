...
export declare class FeedFactory {
    ...
    accountFollowing(options?: string | number | Partial<Pick<AccountFollowingFeed, 'searchSurface' | 'order' | 'query' | 'enableGroups' | 'includesHashtags' | 'id'>>): AccountFollowingFeed;
    news(): NewsFeed;
